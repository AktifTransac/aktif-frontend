        ...
        <div v-for="(bien, i) in displayed" :key="i">
              ...
              <div>
                <nuxt-link
                  :to="
                    $i18n.path('biens') +
                    '/' +
                    bien.INFO_GENERALES.AFF_NUM._text
                  "
                  class="btn-biens"
          ...
          <aside>
            ...
            <div>
              <p>{{ prix(bien) }}</p>
              <p>{{ surface(bien) }} m²</p>
              <p v-show="pieces(bien) !== '0'">
                {{ pieces(bien) }} {{ $t('goods.rooms') }}
              </p>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  @click="fbShare(bien.INFO_GENERALES.AFF_NUM._text)"
                >
                  <path
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  @click="mailShare(bien.INFO_GENERALES.AFF_NUM._text)"
                >
                  <path
  ...
  methods: {
    ...
    description(bien) {
      ...
      for (let i = 0; i <= numberOfChar; i++) {
        if (
          i === numberOfChar &&
          bien.COMMENTAIRES.FR._cdata.charAt(i + 1) !== ' '
        ) {
          numberOfChar++
        }
        truncated.push(bien.COMMENTAIRES.FR._cdata.charAt(i))
      }
      truncated.push('...')

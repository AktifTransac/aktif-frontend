<!-- /!\ ATTENTION LE CODE D'ACCES A L'ENFER SE TROUVE DANS CE FICHIER... /!\ -->
<template>
  <div>
...
export default {
  ...
  mounted() {
    if (Object.keys(this.$route.query).length) {
      ...
      } else if (route.projet === 'Magasin' || route.projet === 'FDC') {
        this.filters.type.boutique = true
      } else if (route.projet === 'Local') {
        this.filters.type.autre = true
  ...
  head() {
    return {
      title: `${this.$t('links.property')} - Aktif Transac`,
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$t('meta.property'),
        },
      ],
    }
  },
